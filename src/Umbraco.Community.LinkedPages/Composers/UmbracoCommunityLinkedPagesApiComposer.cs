    ...
    public class UmbracoCommunityLinkedPagesApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco Community Linked Pages Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbracoCommunityLinkedPagesOperationSecurityFilter>();
            });
        }

        public class UmbracoCommunityLinkedPagesOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.LinkedPages.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
